...
gmx mdrun -deffnm {base_job_name}_solv_minsd -maxwarn 1
...
gmx grompp -f FORCEFIELD-inputs/FORCEFIELD_nvt_heat.mdp -c {base_job_name}_ions_minsd.gro -r {base_job_name}_ions_minsd.gro -p topol.top -o {base_job_name}_nvt_heat.tpr
